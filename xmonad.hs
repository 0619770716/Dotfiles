...
blue 		= "#458588"
    ...
    -----------------------------------------------------------------------
myGaps		    = gaps [(U,20), (R,0), (L,0), (D,0)]                                                                        -- Gaps 
mySpaceLayout 	= spacingRaw True (Border 0 10 10 10) True (Border 10 10 10 10) True                                        --spacing in window

layout  	    = mkToggle (NOBORDERS ?? FULL ?? EOT)                                                                       --fullScreen
                $ avoidStruts (spiral (6/7) |||  simpleTabbed  )                                                            --layout
