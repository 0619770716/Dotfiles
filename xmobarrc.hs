-- XMobar config
--
Config { font    = "xft:JetBrains Mono:weight=Bold:pixelsize=13:antialias=true:hinting=true"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = " <icon=haskell_20.xpm/> <fc=#b8bb26> | </fc>%UnsafeStdinReader% }{ <fc=#ffff5f>%cpu%</fc> | <fc=#ff5f87>%memory%</fc> | <fc=#87afd7>%disku%</fc> | <fc=#d79921>%battery%</fc> | <fc=#b294bb>%uptime%</fc> | <fc=#afd75f>%date%</fc> "
